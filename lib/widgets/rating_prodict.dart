...
class RatingProdict extends StatefulWidget {
  ...
  @override
  _RatingProdictState createState() => _RatingProdictState();
}

class _RatingProdictState extends State<RatingProdict> {
  double _rating = 0;
  ...
  _updateRating(double newRating) {
